...
# Mind that: 
# (a) participants were splitted twice, since it was hard to tell where to put the Middle Income (and if indeed these are mid-Income people)
# (b) the objects we are working with are still called "F25" and "M25". It was simply unbearable to keep updating
#     the names so they correspond to the model(s). It's not an oversight. It's time-saving measure.
#     Also the names of the figures may be outdated. There are around 30 images in the Supplement, we beleive 
#     it's better to focus if they are where they should be and on interpreting what they actually say, compared
#     to whether they are correctly labeled. Thank you for your understanding. 
#.-.-.-.-.-.-.-.-.-.-.-.

library(rethinking)

F25 <- readRDS("post_F_ATD_FAMI_BACK_two_Upper_REV_29_08_25.RDS")

str(F25)

M25 <- readRDS("post_M_ATD_FAMI_BACK_two_Upper_REV_29_08_25.RDS")
...
tiff("Correlations_Heatmap_A_Females_Attr_Above_Below_SES_ver_1_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AF
dev.off()

tiff("Correlations_Heatmap_T_Females_Tru_Above_Below_SES_ver_1_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AT
dev.off()

tiff("Correlations_Heatmap_D_Females_Dom_Above_Below_SES_ver_1_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AD
dev.off()
...
tiff("Correlations_Heatmap_A_Males_Attr_Above_Below_SES_ver_1_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AF
dev.off()

tiff("Correlations_Heatmap_T_Males_Tru_Above_Below_SES_ver_1_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AT
dev.off()

tiff("Correlations_Heatmap_D_Males_Dom_Above_Below_SES_ver_1_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AD
dev.off()
...
tiff("F_ATD_SES_ver_1_LEVELS_NOLABELS_REV.tiff",width=30,height=14,units="cm",res=600,compression="lzw")
...
tiff("F_ATD_GMM_SES_ver_1_COEFS_REV.tiff",width=30,height=33,units="cm",res=600,compression="lzw")
...
tiff("M_ATD_SES_ver_1_LEVELS_NOLABELS_REV.tiff",width=30,height=14,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.8,1.2,1.2),heights=c(1))
...
tiff("M_ATD_GMM_SES_ver_1_no_COEFS_REV.tiff",width=30,height=33,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.1,0.7,0.7),heights=c(1))
...
# 1 both posteriors as vector - subset randomly from the longer... 
mean(as.vector(within_mat) - sample(as.vector(between_mat),5000))
...
F25 <- readRDS("post_F_ATD_FAMI_BACK_three_Upper_REV_29_08_25.RDS")

str(F25)

M25 <- readRDS("post_M_ATD_FAMI_BACK_three_Upper_REV_29_08_25.RDS")
...
tiff("Correlations_Heatmap_A_Females_Attr_Above_Below_SES_ver_2_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AF
dev.off()

tiff("Correlations_Heatmap_T_Females_Tru_Above_Below_SES_ver_2_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AT
dev.off()

tiff("Correlations_Heatmap_D_Females_Dom_Above_Below_SES_ver_2_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AD
dev.off()
...
tiff("Correlations_Heatmap_A_Males_Attr_Above_Below_SES_ver_2_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AF
dev.off()

tiff("Correlations_Heatmap_T_Males_Tru_Above_Below_SES_ver_2_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AT
dev.off()

tiff("Correlations_Heatmap_D_Males_Dom_Above_Below_SES_ver_2_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AD
dev.off()
...
tiff("F_ATD_SES_ver_2_LEVELS_NOLABELS_REV.tiff",width=30,height=14,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.8,1.2,1.2),heights=c(1))
...
tiff("F_ATD_GMM_SES_ver_2_COEFS_REV.tiff",width=30,height=33,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.1,0.7,0.7),heights=c(1))
...
tiff("M_ATD_SES_ver_2_LEVELS_NOLABELS_REV.tiff",width=30,height=14,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.8,1.2,1.2),heights=c(1))
...
tiff("M_ATD_GMM_SES_ver_2_no_COEFS_REV.tiff",width=30,height=33,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.1,0.7,0.7),heights=c(1))
