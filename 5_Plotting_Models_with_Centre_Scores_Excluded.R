...
M25 <- readRDS("post_F_ATD_25_19_03_25_long.RDS")

str(F25)

M25 <- readRDS("post_M_ATD_25_19_03_25_long.RDS")
...
tiff("Correlations_Heatmap_A_Females_Attr_wide_25_PercMiss.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AF
dev.off()

tiff("Correlations_Heatmap_T_Females_Tru_wide_25_PercMiss.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AT
dev.off()

tiff("Correlations_Heatmap_D_Females_Dom_wide_25_PercMiss.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AD
dev.off()
...
tiff("Correlations_Heatmap_A_Males_Attr_wide_25_PercMiss.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AF
dev.off()

tiff("Correlations_Heatmap_T_Males_Tru_wide_25_PercMiss.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AT
dev.off()

tiff("Correlations_Heatmap_D_Males_Dom_wide_25_PercMiss.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AD
dev.off()
...
tiff("F_ATD_25_missing_model_LEVELS_NOLABELS.tiff",width=30,height=14,units="cm",res=600,compression="lzw")
...
tiff("F_ATD_GMM_25_missing_no_COEFS.tiff",width=30,height=33,units="cm",res=600,compression="lzw")
...
tiff("M_ATD_25_missing_model_LEVELS_NOLABELS.tiff",width=30,height=14,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.8,1.2,1.2),heights=c(1))
...
tiff("M_ATD_GMM_25_missing_no_COEFS.tiff",width=30,height=33,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.1,0.7,0.7),heights=c(1))
