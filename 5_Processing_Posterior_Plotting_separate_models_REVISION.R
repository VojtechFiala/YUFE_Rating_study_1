...
post_A_F <- readRDS("post_F_Atr_22_08_25_Long.RDS") # This is a model with A

str(post_A_F)

# - Trustw

post_T_F <- readRDS("post_F_Tru_22_08_25_Long.RDS") # This is a model with T 

str(post_T_F)

# - Dom 

post_D_F <- readRDS("post_F_Dom_22_08_25_Long.RDS") # This is a model with D 
...
post_A_M <- readRDS("post_M_Atr_23_08_25_Long.RDS") # This is a model with A 

str(post_A_M)

# - Trustw

post_T_M <- readRDS("post_M_Tru_23_08_25_Long.RDS") # This is a model with T 

str(post_T_M)

# - Dom 

post_D_M <- readRDS("post_M_Dom_23_08_25_Long.RDS") # This is a model with D  
...
tiff("Correlations_Heatmap_ONLY_A_Females_Attr_wide_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AF
dev.off()

tiff("Correlations_Heatmap_ONLY_T_Females_Tru_wide_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AT
dev.off()

tiff("Correlations_Heatmap_ONLY_D_Females_Dom_wide_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AD
dev.off()
...
tiff("Correlations_Heatmap_ONLY_A_Males_Attr_wide_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AF
dev.off()

tiff("Correlations_Heatmap_ONLY_T_Males_Tru_wide_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AT
dev.off()

tiff("Correlations_Heatmap_ONLY_D_Males_Dom_wide_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AD
dev.off()
...
tiff("F_ATD_separate_models_LEVELS_NOLABELS_REV.tiff",width=30,height=14,units="cm",res=600,compression="lzw")
...
tiff("F_ATD_GMM_SEPARATELY_no_COEFS_REV.tiff",width=30,height=33,units="cm",res=600,compression="lzw")
...
# Please ignore F in the objects' names - it's males. I am just too lazy to upade that. 
...
tiff("M_ATD_separate_models_LEVELS_NOLABELS_REV.tiff",width=30,height=14,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.8,1.2,1.2),heights=c(1))
...
tiff("M_ATD_GMM_SEPARATELY_no_COEFS_REV.tiff",width=30,height=33,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.1,0.7,0.7),heights=c(1))
