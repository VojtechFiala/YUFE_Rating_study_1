#.-.-.-.-.-.-.-.-.-.-.-.
# 
# Participants who scored in 25% band around median for at least two of the three main scores around median excluded
# Explanation: Participants who fell in the 25% percentile of scores (around median)
#
#.-.-.-.-.-.-.-.-.-.-.-.

library(rethinking)

load("mod_F_ATD_out25_25_08_25_Long.RDS")

load("mod_M_ATD_out25_25_08_25_Long.RDS")

F25 <- extract.samples(ATD_25_F)
M25 <- extract.samples(ATD_25_M)

str(F25)
str(M25)


# F in the objects' names does not mean anything - it's because I run the analysis for men rewriting 
# objects from females (changing every _F for _M would be too mu)
...
tiff("Correlations_Heatmap_A_Females_Attr_wide_25_PercMiss_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AF
dev.off()

tiff("Correlations_Heatmap_T_Females_Tru_wide_25_PercMiss_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AT
dev.off()

tiff("Correlations_Heatmap_D_Females_Dom_wide_25_PercMiss_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AD
dev.off()
...
tiff("Correlations_Heatmap_A_Males_Attr_wide_25_PercMiss_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AF
dev.off()

tiff("Correlations_Heatmap_T_Males_Tru_wide_25_PercMiss_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AT
dev.off()

tiff("Correlations_Heatmap_D_Males_Dom_wide_25_PercMiss_REV.tiff",width=57,height=25,units="cm",res=600,compression="lzw")
AD
dev.off()
...
# Figure S10 - analogue of the Figure 3 in the main body of the article, which is a figure (top) presenting mean estimates
...
tiff("F_ATD_25_missing_model_LEVELS_NOLABELS_REV.tiff",width=30,height=14,units="cm",res=600,compression="lzw")
...
tiff("F_ATD_GMM_25_missing_no_COEFS_REV.tiff",width=30,height=33,units="cm",res=600,compression="lzw")
...
# Figure S11 - analogue of the Figure 4 in the main body of the article, which is a figure (top) presenting mean estimates
# in every sample, (bottom) presenting effects of morphometric and demographic predictors: SPECIFICALLY for WOMEN
# Version without labels
...
tiff("M_ATD_25_missing_model_LEVELS_NOLABELS_REV.tiff",width=30,height=14,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.8,1.2,1.2),heights=c(1))
...
tiff("M_ATD_GMM_25_missing_no_COEFS_REV.tiff",width=30,height=33,units="cm",res=600,compression="lzw")
layout(matrix(1:3,byrow=F,nrow=1), widths=c(1.1,0.7,0.7),heights=c(1))
